...
import com.github.mawen12.easeagent.core.plugins.redis.trace.JedisTraceInterceptor;
...
public class JedisTransformer extends AbstractClassTransformer {
    ...
    protected List<Interceptor> getInterceptors() {
        return Lists.of(JedisMetricInterceptor.INSTANCE, JedisTraceInterceptor.INSTANCE);
    }
